 ...
 *  메세지의 종류
 *  
 *  1. 일반 대화 메세지 {"type":"msg" "name":"대화명","content":"안녕하세요"}
 *  2. 누군가 입장했다는 메세지 {"type":"enter",:"name":"대화명"}
 *  3. 누군가 퇴장했다는 메세지 {"type":"out":"대화명2"}
 *  4. 참여자 목록 메세지
 *  {"type" :"members","list":["대화명1","대화명2","대화명3"]}
 */
public class ClientMain extends JFrame implements ActionListener, KeyListener{
	...
	public ClientMain() {
		...
		chatName=JOptionPane.showInputDialog(this, "대화명 입력하세요");
		...
		public void updateTextArea(String msg) {
			try {
				...
				if(type.equals("enter")) { //입장메세지라면
					...
					area.append("\r\n");	
				}else if(type.equals("members")) { //대화참여자 목록이 도착
